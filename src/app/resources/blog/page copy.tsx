...
const customTheme = {
  ...
  modal: {
    content: {
      ...
      inner: "relative flex max-h-screen h-screen flex-col bg-white rounded-[24px]",
    },
    header: {
                ...
                <ul className="flex flex-col p-4 xl:p-0 text-[16px] xl:text-[14px] mt-0 border-t border-[#ffffffb3] bg-black xl:bg-transparent space-y-3 xl:space-y-0 xl:flex-row xl:space-x-8 rtl:space-x-reverse xl:mt-0 xl:border-0">
                  {["Company", "Products", "Solutions", "Developers", "Resources"].map((item) => (
                    <li key={item}>
                      <Link
                        href="#"
                        className="text-black font-normal tracking-[-0.54px] hover:text-[#FE6623] transition-colors duration-300"
                      >
                        {item}
                      </Link>
                    </li>
                  ...
                  <li>
                    <Link
                      href="#"
                      className="text-black font-normal text-[14px] xl:text-[14px] border py-[4px] px-[24px] rounded-[24px] border-[#fe6623] hover:bg-[#fe6623] hover:text-white transition-all duration-300"
                    >
                      Login
                    </Link>
                  </li>
          ...
          <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative">
            ...
            >
              ...
              >
                ...
                <motion.span 
                  className="text-[#FE6623] font-medium"
                  whileHover={{ scale: 1.05 }}
                >
                  HEALTHCARE
                </motion.span>
              ...
              >
                ...
                <motion.div 
                  ...
                  whileHover={{ scale: 1.05 }}
                >
                  <button className="flex items-center gap-2 text-gray-600 hover:text-[#FE6623] transition-colors">
                ...
                <ul className="space-y-3 text-[#525252]">
                  {[
                    ...
                    <motion.li key={section.id}>
                      <motion.a
                        href={`#${section.id}`}
                        className={`flex items-start gap-2 text-[12px] font-normal transition-all duration-300 ${activeSection === section.id ? 'text-[#FE6623] font-medium' : 'text-gray-600 hover:text-[#FE6623]'}`}
                        onClick={(e) => {
                          e.preventDefault();
                ...
                >
                  {[
                    ...
                    <motion.div 
                      ...
                      whileHover={{ y: -5 }}
                    >
                      <h3 className="text-4xl font-bold text-[#FE6623] mb-2">{stat.number}</h3>
                   ...
                   >
                     <div className="flex items-start">
                       <div className="w-12 h-12 rounded-full bg-[#FE6623]/10 flex items-center justify-center mr-4 flex-shrink-0">
                         <svg className="w-6 h-6 text-[#FE6623]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                           {feature.icon === "pill" && (
             ...
             >
               {[
                 ...
                 >
                   ...
                   <motion.a 
                     href="#" 
                     className="text-[#FE6623] text-xl absolute bottom-8 transition-colors duration-200 inline-flex items-center"
                     whileHover={{ x: 5 }}
                   >
                       ...
                       <ul className="m-0 p-0">
                         {column.links.map((link) => (
                           ...
                           >
                             <Link
                               href="#"
                               className="text-[#707070] text-[16px] lg:text-[20px] hover:text-[#FE6623] transition-colors duration-300"
                             >
                               {link}
                             </Link>
                           </motion.li>
               ...
               <div className="basis-full mt-[15px] lg:mt-[0px] lg:basis-5/12">
                 <div className="flex flex-wrap justify-between lg:justify-end items-center">
                   {[
                     ...
                     >
                       <Link
                         className="text-[#55576A] hover:text-[#FE6623] transition-colors duration-300"
                         href={social.href}
                       >
               ...
               <ul className="flex justify-center">
                 {["Legal", "Privacy", "Trust"].map((item) => (
                   <motion.li 
                     ...
                     whileHover={{ y: -2 }}
                   >
                     <Link href="#" className="text-[#292C33] text-[14px] hover:text-[#FE6623] transition-colors duration-300">
                       {item}
                     </Link>
                   </motion.li>
                 ))}
